...
describe CarRental do
  describe '#fields_must_be_present' do
    ...
    it 'should prevent car_insurance to be blank' do
      ...
      car_rental.valid?
      expect(car_rental.errors.full_messages).to include('Car insurance não '\
                                                         'pode ficar vazio')
    end
    it 'should prevent third_party_insurance to be blank' do
      car_rental = CarRental.new(third_party_insurance: nil)
      car_rental.valid?
      expect(car_rental.errors.full_messages).to include('Third party '\
                                                         'insurance não pode '\
                                                         'ficar vazio')
    end
  ...
  describe '#daily_rate_total' do
    it 'must sum daily rate, car insurance and third party insurance' do
      car_rental = build(:car_rental,
                         daily_rate: 20, car_insurance: 100,
